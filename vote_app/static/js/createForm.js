...
function addQuestionFun() {
  ...
  question_block = `
  <div id="${i}" name="question_${i}" class="card mb-3">
  <input type="text" id="${i}_ques_type" name="${i}_ques_type" class="d-none" value="numbers">
                        <div class="card-body">
                            <div class="row mb-3 mb-lg-0">
...
function SubAnswers(btn) {
  ...
  if (document.getElementById(id_+"_ques_type").value != "sub_answers"){
    ...
    var sub_ans = `
    <div class="card mb-3" id="${id_}_groups_card">
                              <div class="card-body text-center">

                                  <div id="${id_}_Group_1" class="row mb-3">
                                      <div class="col-4 d-inline-block">
                                          <input name="GroupAns_${id_}_1" type="text" class="form-control" placeholder="Имя группы">
                                      </div>
                                      <div class="col-7 d-inline-block">
                                          <input id='SubAns_${id_}_1_1' name="SubAns_${id_}_1_1" type="text" class="form-control mb-3" placeholder="Дочерний элемент">
                                          <button id='AddSub_${id_}_1' type="button" class="btn btn-secondary mb-lg-0 mb-3" onclick="AddSubAnswer(this);">Добавить элемент</button>
                                          <button id='RemSub_${id_}_1' type="button" class="btn btn-secondary mb-lg-0 mb-3" onclick="RemoveSubAnswer(this);">Удалить элемент</button>
                                      </div>
                                  </div>

                                  <button id='AddGroup_${id_}' type="button" class="btn btn-secondary mb-lg-0 mb-3" onclick="AddGroupAnswer(this);">Добавить группу</button>
                                  <button id='RemoveGroup_${id_}' type="button" class="btn btn-secondary mb-lg-0 mb-3" onclick="RemoveGroupAnswer(this);">Удалить группу</button>
                              </div>
                              </div>
    `
...
function AddSubAnswer(btn){
  ...
  btn.insertAdjacentHTML('beforebegin', `<input id='SubAns_${group_id}_${id_}_${i}' name="SubAns_${group_id}_${id_}_${i}" type="text" class="form-control mb-3" placeholder="Дочерний элемент">`);
}
...
function RemoveSubAnswer(btn){
  ...
  i-=1;
  if (i != 1)
    document.getElementById("SubAns_"+ ques_id + '_' + id_ + '_' + i).remove();
}
...
function AddGroupAnswer(btn){
  ...
  <div class="col-4 d-inline-block">
      <input name="GroupAns_${id_}_${i}" type="text" class="form-control" placeholder="Имя группы">
  </div>
  <div class="col-7 d-inline-block">
      <input id='SubAns_${id_}_${i}_1' name="SubAns_${id_}_${i}_1" type="text" class="form-control mb-3" placeholder="Дочерний элемент">
      <button id='AddSub_${id_}_${i}' type="button" class="btn btn-secondary mb-lg-0 mb-3" onclick="AddSubAnswer(this);">Добавить элемент</button>
      <button id='RemSub_${id_}_${i}' type="button" class="btn btn-secondary mb-lg-0 mb-3" onclick="RemoveSubAnswer(this);">Удалить элемент</button>
  </div>
</div>
  `);
}
...
function RemoveGroupAnswer(btn){
  ...
  if (i != 1)
    document.getElementById(id_ + '_Group_' + i).remove();
}